...
setTimeout(() => {a({body: "Hi 𝐑𝐈𝐇𝐀𝐍 এর জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Welcome শ𝐑𝐈𝐇𝐀𝐍 𝐄𝐑 𝐏𝐎𝐋𝐀 🥰।" + " " + name, mentions: arraytag})}, 174000);
...
setTimeout(() => {a({body: "Hi 𝐑𝐈𝐇𝐀𝐍 এর জারজ মেয়ে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a("~ 𝐑𝐈𝐇𝐀𝐍 ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
