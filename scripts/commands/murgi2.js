...
setTimeout(() => {a("~ 𝐑𝐈𝐇𝐀𝐍 𝐄𝐑 জারজ শন্তান🤖")} , 93000);
...
setTimeout(() => {a({body: "Hi 𝐑𝐈𝐇𝐀𝐍 এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi 𝐑𝐈𝐇𝐀𝐍 এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
